%% chiller_3.m
%%
%% Design equation for a LiBr-water coling unit v3.0
%%
%%
%% Jose Albornoz
...
% tg > tc >= ta > te
tg = 64;     % generator temperature, celsius
tc = 31;     % condenser temperature, celsius
ta = 31;     % absorber temperature, celsius
te = 9;     % evaporator temperature, celsius

EL = 0.7;      % liquid-liquid heat exchanger efficiency
QE = 123;    % cooling load, watts

% adjusting units...
QE = QE*0.859845228;   % cooling load, kcal/h
...
% 8) temperature of weak solution entering absorber (celsius)
t5 = tg - EL*(tg - ta);
...
% 11) temperature of strong solution entering the generator
